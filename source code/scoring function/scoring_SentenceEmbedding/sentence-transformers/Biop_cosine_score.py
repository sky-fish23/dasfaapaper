...
with open("./BioMCS/BioMCS1.txt") as f:
    K1 = f.read().split("\n\n")
    for axiom in K1:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS2.txt") as f:
    K2 = f.read().split("\n\n")
    for axiom in K2:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS3.txt") as f:
    K3 = f.read().split("\n\n")
    for axiom in K3:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS4.txt") as f:
    K4 = f.read().split("\n\n")
    for axiom in K4:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS5.txt") as f:
    K5 = f.read().split("\n\n")
    for axiom in K5:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS6.txt") as f:
    K6 = f.read().split("\n\n")
    for axiom in K6:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS7.txt") as f:
    K7 = f.read().split("\n\n")
    for axiom in K7:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS8.txt") as f:
    K8 = f.read().split("\n\n")
    for axiom in K8:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS9.txt") as f:
    K9 = f.read().split("\n\n")
    for axiom in K9:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS10.txt") as f:
    K10 = f.read().split("\n\n")
    for axiom in K10:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS11.txt") as f:
    K11 = f.read().split("\n\n")
    for axiom in K11:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS12.txt") as f:
    K12 = f.read().split("\n\n")
    for axiom in K12:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS13.txt") as f:
    K13 = f.read().split("\n\n")
    for axiom in K13:
        Kset.add(axiom)
    f.close()

with open("./BioMCS/BioMCS14.txt") as f:
    K14 = f.read().split("\n\n")
    for axiom in K14:
        Kset.add(axiom)
    f.close()
